...
urlpatterns = [
    ...
    path('books/issue/<int:book_id>',
         views.IssueBookCBView.as_view(), name='issuebook'),
    path('mybooks', views.MybookCBV.as_view(), name='mybooks'),
    path('mybooks/cancel/<int:book_id>',
         views.MybookcancelCBV.as_view(), name='cancel'),
    path('mybooks/return/<int:book_id>',
         views.MybookreturnCBV.as_view(), name='return'),
    ...
    path('mybooks/queue/<int:book_id>',
         views.UserWaitingList.as_view(), name='userqueue'),
    path('mybooks/queue/cancel/<int:book_id>',
         views.UserWaitingCancel.as_view(), name='queuecancel'),
]
